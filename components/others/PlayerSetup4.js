...
const PlayerSetup4 = ({ onSetupComplete }) => {
  ...
  const handleSubmit = () => {
    if (player1Name && player2Name && player3Name && player4Name) {
      onSetupComplete({
        ...
        player4: { name: player4Name, symbol: player4Symbol },
      });
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <Text style={[styles.symbol, { color: getSymbolColor(player1Symbol) }]}>
          {player1Symbol}
        </Text>
        <TextInput
      ...
      <View style={styles.inputContainer}>
        <Text style={[styles.symbol, { color: getSymbolColor(player2Symbol) }]}>
          {player2Symbol}
        </Text>
        <TextInput
      ...
      <View style={styles.inputContainer}>
        <Text style={[styles.symbol, { color: getSymbolColor(player3Symbol) }]}>
          {player3Symbol}
        </Text>
        <TextInput
      ...
      <View style={styles.inputContainer}>
        <Text style={[styles.symbol, { color: getSymbolColor(player4Symbol) }]}>
          {player4Symbol}
        </Text>
        <TextInput
          style={[styles.input, { color: getSymbolColor(player4Symbol) }]}
